...
def client_with_data():
    ...
    zipped_file_path= di.set_path_zip_file(os.path.join(test_data_folder,"dummy_taxtree_dump.zip"))
    di._path_zip_file = os.path.join(test_data_folder,"dummy_taxtree_dump.zip")
    unzipped_data_folder_path = di.set_path_unziped_data_folder(os.path.join(test_data_folder,"unzipped"))
    dm.set_importer(di)
    dm.import_data()
